...
// tna6
template <typename Dtype>
void caffe_round_inplace(const int N, const Dtype lower_lim, const Dtype upper_lim, const Dtype epsilon, Dtype* Y, int* under, int* over);

template <typename Dtype>
void caffe_round(const int N, const Dtype lower_lim, const Dtype upper_lim, const Dtype epsilon, const Dtype* X, Dtype* Y, int* under, int* over);

template <typename Dtype>
void caffe_zero_out_inplace(const int N, const Dtype zero_out, Dtype* Y, int* num_zero);
// tna6
...
// tna6
template <typename Dtype>
int caffe_cpu_iamax(const int n, const Dtype* x);
...
// tna6
template <typename Dtype>
void caffe_gpu_round_inplace(const int N, const Dtype lower_lim, const Dtype upper_lim, const Dtype epsilon, Dtype* Y, int* under, int* over);

template <typename Dtype>
void caffe_gpu_round(const int N, const Dtype lower_lim, const Dtype upper_lim, const Dtype epsilon, const Dtype* X, Dtype* Y, int* under, int* over);

template <typename Dtype>
void caffe_gpu_zero_out_inplace(const int N, const Dtype zero_out, Dtype* Y, int* num_zero);
// tna6
...
// tna6
template <typename Dtype>
void caffe_gpu_iamax(const int n, const Dtype* x, int* y);
